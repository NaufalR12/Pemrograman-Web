...
<body>
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col pt-3" style="padding-left: 2.5rem">
                            ...
                            <img src="gambar/loginn.png" style="padding-left: 5rem" class="mt-0" width="400px" alt="" />
                        </div>
                        <div class="col mb-5">
                            <h1>Welcome Back</h1>
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col pt-3" style="padding-left: 2.5rem">
                            ...
                            <img src="gambar/login.png" class="mt-0" width="500px" alt="" />
                        </div>
                        <div class="col mb-5">
                            <h1>Let's Join Us</h1>
                            <p class="mb-4">
    ...
    <div id="carouselExampleIndicators" class="carousel slider mt-3" style="width: 65vw; margin: auto; top: 10px">
    ...
    <!-- Notifikasi start -->
    <div class="notifikasi" id="item-detail-notifikasi">
        <div class="notifikasi-container">
            <a href="#" class="close-icon"><i data-feather="x"></i></a>
            <div class="notifikasi-content">
                <img src="img/check-circle (2).png" alt="check-circle" />
        ...
        <div class="container text-center pb-5">
            <div class="row justify-content-start">
                <div class="col-8 text-start mt-5">
                    ...
                    <button class="btn btn-custom3 text-custom4 rounded-pill w-35 me-2" style="width: 25%; height: 18%">
                        <p style="font-size: 20px">Selengkapnya</p>
                    </button>
                </div>
