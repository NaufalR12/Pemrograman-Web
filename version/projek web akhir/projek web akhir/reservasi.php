...
<html lang="en">
  ...
  <body>
    ...
    <select name="id_dokter" id="dokter" class="form-select mb-3" aria-label="Default select example" required>
    <option value="" disabled selected>Pilih Dokter</option>
        <?php
        while ($rowDokter = $resultDokter->fetch_assoc()) {
            echo "<option value='{$rowDokter['id_dokter']}'>{$rowDokter['nama_dokter']} - {$rowDokter['spesialisasi']}</option>";
        }
        ?>
    </select>
