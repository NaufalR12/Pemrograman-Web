...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,700;1,
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-custom">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <img
            src="gambar/logo klinik (1v3) 3.png"
            alt="Logo Dentismiles"
            height="50"
          />
        </a>
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          >
            ...
            <li class="nav-item">
              <a class="nav-link text-white" href="#" id="menuNavbar"
                >Reservasi</a
              >
            </li>
          </ul>
    ...
    <?php
        ...
        // echo "<h3>Berikut ini daftar dokter berdasarkan spesialisasi $jenis</h3>";
        echo "<table border='0'>";
        ...
        if (!$sambungan) {
          ...
          $query = "SELECT id_dokter, nama_dokter, spesialisasi, jam_praktik, gambar FROM dokter LIMIT 5";
          ...
          while ($baris = mysqli_fetch_assoc($hasil_query)) {
              ...
              $jam_praktik = $baris['jam_praktik'];

              // Mengonkatenate path folder dan nama gambar
              $gambar_path = "gambar/dokter/" . $gambar;
        
            echo "<tr>";
          echo "<td style='padding-left: 70px;' ><img src='$gambar_path' alt='$nama_dokter'></td>";
          echo "<td style='padding-right: 70px;'><b>$nama_dokter</b><br>Spesialisasi: $spesialisasi<br>Jam Praktik: $jam_praktik</td>";
          echo "<br></tr>";
          ...
          <div class="col-3 mt-5">
            <center>
              <a href="http://instagram.com/"
                ><img width="45rem" src="gambar/ig.png" alt=""
              /></a>
              <a href="http://twitter.com/"
                ><img width="45rem" src="gambar/tw.png" alt=""
              /></a>
              <a href="http://facebook.com/"
                ><img width="45rem" src="gambar/fb.png" alt=""
              /></a>
              <div class="apk mt-2">
