...
if ($conn->connect_error) {
    // Jika koneksi gagal, hentikan program dan tampilkan pesan kesalahan
    ...
    <table border="1">
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                // Membuat hyperlink ke halaman 'product.php' dengan parameter 'productID'
                echo "<td><a href=\"product.php?productID={$row['ProductID']}\">{$row['ProductName']}</a></td>";
                // Menampilkan harga produk dengan format dolar
...
<?php
// Tutup koneksi database setelah selesai mengaksesnya
$conn->close();
?>