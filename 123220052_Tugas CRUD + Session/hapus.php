    ...
    ?> <center>
        ...
        if ($query) {
            if (mysqli_affected_rows($connect) > 0) {
                echo "<p>Proses hapus berhasil, ingin lihat hasil <a href='main.php'><button class=\"btn\" style=\"background-color: #465771; color: #ffff\" type=\"submit\">disini</button></a></p>";
            } else {
                echo "<p>ID menu tidak ditemukan atau tidak ada yang dihapus</p>";
            }
        } else {
