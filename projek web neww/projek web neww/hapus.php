...
<body>
    ...
    $query = "SELECT id_dokter, nama_dokter FROM dokter WHERE id_dokter = $id_dokter";
    ...
    if ($hasil_query && mysqli_num_rows($hasil_query) > 0) {
        ...
        // Tampilkan data dokter dan konfirmasi hapus
    ?>
                                <p>Anda yakin ingin menghapus data dokter <?php echo $data_dokter['nama_dokter']; ?>?
                                </p>
                                <form action="proses_hapus_dokter.php" method="post">
                                    <input type="hidden" name="id_dokter"
                                        value="<?php echo $data_dokter['id_dokter']; ?>">
                                    <button type="submit" value="Ya, Hapus" class="btn btn-danger me-2">Hapus</button>
                                    <a href="tampil_dokter_admin.php"><button type="button"
