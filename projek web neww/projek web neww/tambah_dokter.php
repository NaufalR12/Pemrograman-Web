...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = "INSERT INTO dokter (nama_dokter, spesialisasi, jam_praktik, foto_profil) VALUES ('$nama_dokter', '$spesialisasi', '$jam_praktik', '$foto_profil')";
                ...
                <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="profiladmin.php">Profil</a></li>
                            <li>
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center align-items-center mb-3">
                    ...
                    <div class="col-3 text-start">
                        <input type="text" placeholder="Masukan Spesialisasi Dokter" class="form-control ms-5"
                            id="spesialisasi" name="spesialisasi" required><br>
                    </div>
                </div>
                <div class="row justify-content-center align-items-center mb-3">
                    <div class="col-2 text-center" style="color: #465771; font-size: 20px;">
                    ...
                    <div class="col-3 text-center">
                        <input placeholder="Jam Praktik" type="text" name="jam_praktik" required
                            class="form-control ms-5" id="jam_praktik">
                    </div>
                </div>
                <div class="row justify-content-center align-items-center mb-3">
                    <div class="col-2 text-center" style="color: #465771; font-size: 20px;">
